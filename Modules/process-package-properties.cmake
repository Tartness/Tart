...
# PROCESS_TARGET_OS_PROPERTIES() Process all entries of the custom configuration properties list from a tart.yaml file
#
...
# PROCESS_TARGET_ARCH_PROPERTIES() Process all entries of the custom configuration properties list from a tart.yaml file
#
FUNCTION(PROCESS_TARGET_ARCH_PROPERTIES PACKAGE_TARGET ENTRIES ENTRY_INDENTS)
  ...
  TART_TMP("TART_TARGET_ARCH: ${TART_TARGET_ARCH}")
  ...
  FOREACH(TARGET_ARCH ${TARGET_ARCH_LIST})
    ...
    FOREACH(TARGET_ARCH_PROPERTY ${TARGET_ARCH_PROPERTIES})
      ...
      TART_TMP("   ${TARGET_ARCH} property: ${PROPERTY_KEY}")
      STRING(REGEX MATCH "[ ].+$" PROPERTY_VALUE "${TARGET_ARCH_PROPERTY}")
      IF(${PROPERTY_VALUE})
        TART_TMP("   ${TARGET_ARCH} value: ${PROPERTY_VALUE}")
        SET_TARGET_PROPERTIES(${PACKAGE_TARGET} PROPERTIES "${PROPERTY_KEY}" "${PROPERTY_VALUE}")
      ENDIF()
    ENDFOREACH()
  ENDFOREACH()
