FUNCTION(PARSE_YAML YAML_PATH)
  ...
  FOREACH(YAML_FILE_LINE ${YAML_CONTENT})
    ...
    # Set the variable
    IF(${LAST_NODE_IS_LIST})
      #  MESSAGE(STATUS ${LAST_NODE_NAME} ": ${${LAST_NODE_NAME}} ${NODE_VALUE}")
      SET(${LAST_NODE_NAME} "${${LAST_NODE_NAME}} ${NODE_VALUE}")
    ELSE()
