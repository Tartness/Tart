...
FUNCTION(PROCESS_PACKAGE_COMPILE_DEFINITIONS PACKAGE_NAME ENTRIES ENTRY_INDENTS)
  ...
  PROCESS_TARGET_CUSTOM_CONFIG_COMPILE_DEFINITIONS(${PACKAGE_NAME} "${ENTRIES}" "${ENTRY_INDENTS}")
...
# PROCESS_TARGET_CUSTOM_CONFIG_COMPILE_DEFINITIONS() Process entries of the custom configuration compile definition list from a tart.yaml file
#
FUNCTION(PROCESS_TARGET_CUSTOM_CONFIG_COMPILE_DEFINITIONS PACKAGE_TARGET ENTRIES ENTRY_INDENTS)
  ...
  FOREACH(CUSTOM_CONFIG ${CUSTOM_CONFIGURATIONS})
    ...
    ENDFOREACH()
  ENDFOREACH()
ENDFUNCTION(PROCESS_TARGET_CUSTOM_CONFIG_COMPILE_DEFINITIONS)
  ...
  FOREACH(CURRENT_ARCH ${ARCH_LIST})
    IF(${TART_TARGET_ARCH} STREQUAL ${CURRENT_ARCH})
      ...
      FOREACH(TARGET_ARCH_COMPILE_DEFINITION ${TARGET_ARCH_COMPILE_DEFINITIONS})
        TART_DEBUG("${TARGET_ARCH_COMPILE_DEFINITION}")
