...
FUNCTION(GET_LAST_GIT_TAG GIT_REPO_DIR GIT_TAG)
  ...
  IF("${LAST_TAG}" EQUAL "fatal: No names found, cannot describe anything.")
    SET(LAST_TAG "")
  ENDIF()
  TART_LOG("Current git tag is ${LAST_TAG} of repo ${GIT_REPO_DIR}")
...
FUNCTION(GET_CURRENT_GIT_COMMIT_ABBREVIATED_HASH GIT_REPO_DIR COMMIT_HASH)
  ...
  TART_LOG("Current git hash is ${GIT_COMMIT_HASH}")
...
FUNCTION(GIT_CLONE_REPO GIT_REPO_URL DESTINATION_DIR)
  TART_LOG("Cloning ${GIT_REPO_URL}")
  TART_LOG("Into ${DESTINATION_DIR}")
  EXECUTE_PROCESS(
...
FUNCTION(GIT_CHECKOUT GIT_REPO_DIR DESIRED_CHECKOUT)
  TART_LOG("Checking out ${DESIRED_CHECKOUT}")
  TART_LOG("Of Repo ${GIT_REPO_DIR}")
  EXECUTE_PROCESS(
...
FUNCTION(GIT_PULL GIT_REPO_DIR)
  ...
  TART_LOG("Pulling master from ${GIT_REPO_DIR}")
...
FUNCTION(CHECK_IS_DIR_GIT_REPO GIT_REPO_DIR DESIRED_GIT_REPO_URL DIR_IS_GIT_REPO)
  TART_LOG("Checking if ${GIT_REPO_DIR} is a clone of ${DESIRED_GIT_REPO_URL}")
  ...
  IF(EXISTS ${GIT_REPO_DIR})
    ...
    TART_LOG("Repo has desired remote url: ${HAS_DESIRED_REMOTE_URL}")
    SET(${DIR_IS_GIT_REPO} ${HAS_DESIRED_REMOTE_URL} PARENT_SCOPE)
  ELSE()
    TART_LOG(SEND_ERROR "Directory does not exist for checked git repository")
  ENDIF()
