FUNCTION(ADD_DEPENDENCY LIBRARY_NAME PARENT_BUILD_TARGET)
  SET(DEPENDENCY_LIST "")
  TART_PUBLIC("Adding dependency ${LIBRARY_NAME} to target ${PARENT_BUILD_TARGET}")
  SET(LIBRARY_DIR "${CMAKE_CURRENT_LIST_DIR}/../${LIBRARY_NAME}")


  PARSE_YAML("${LIBRARY_DIR}/tart.yaml" NODE_NAMES NODE_VALS NODE_INDENTS)
  ...
  FOREACH(DEPENDENCY_NAME ${TMP})
    ...
    ELSE()
      ...
      IF(NOT HAS_NO_PREVIOUS_ENTRY)
        ADD_DEPENDENCY(${LAST_ENTRY} ${LIBRARY_NAME})
      ENDIF()
  ...
  #   INHERIT_XCODE_COMPILATION_OPTIONS(${PARENT_BUILD_TARGET} ${LIBRARY_NAME})
  # ENDIF()
