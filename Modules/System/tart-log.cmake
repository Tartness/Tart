...
FUNCTION(TART_INFO MESSAGE)
  IF(TRUE)
    MESSAGE("${BoldBlue}‣ Tart Info: ${ColourReset}${Blue}${MESSAGE}${ColourReset}")
  ENDIF()
ENDFUNCTION(TART_INFO)

FUNCTION(TART_WARNING MESSAGE)
  IF(TRUE)
    MESSAGE("${BoldYellow}[!] Tart Warning ${ColourReset}${Yellow}${MESSAGE}${ColourReset}")
  ENDIF()
ENDFUNCTION(TART_WARNING)

FUNCTION(TART_ERROR MESSAGE)
  IF(TRUE)
    MESSAGE(FATAL_ERROR "${BoldRed}[X] Tart Error ${ColourReset}${Red}${MESSAGE}${ColourReset}")
  ENDIF()
